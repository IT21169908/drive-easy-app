...
class SchoolOwnerDashboardLayout extends StatefulWidget {
  const SchoolOwnerDashboardLayout({super.key});

  @override
  State<SchoolOwnerDashboardLayout> createState() =>
      _SchoolOwnerDashboardLayoutState();
}

class _SchoolOwnerDashboardLayoutState
    extends State<SchoolOwnerDashboardLayout> {
  @override
  void initState() {
