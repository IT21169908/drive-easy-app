...
import '../screens/school_owner/layouts/dashboard_layout.dart';
...
class RouteName {
  ...
  static const String schoolOwnerDashboard = '/school-owner/dashboard';
}
...
Map<String, Widget Function(BuildContext)> routes = {
  ...
  RouteName.schoolOwnerDashboard:(context) => const SchoolOwnerDashboardLayout(),
};
